...
public class SmsOutBox implements Serializable {
	...
	protected String messageContent; // MESSAGECONTENT[短信内容当MSGFMT 为4
										// 时,消息内容为十六进制字符串]
	protected int reqDeliveryReport; // REQDELIVERYREPORT[是否需要状态报告0:不需要,1:需要]
	protected int msgFmt; // MSGFMT[消息类型,0- ASCII,4- Binary,8- usc2,15-
								// gb2312,16-gb18030]
	protected int sendMethod; // SENDMETHOD[0-普通短信,1-普通短信立即显示,2-长短信组包,3-带结构短信]
	protected Date requestTime; // REQUESTTIME[入库时间( 短信发送请求时间)]
